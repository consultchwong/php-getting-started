...
echo "<span>* Please enter the correct phone no. *</span>";
} else {
$subject = '香港專科中心有新訊息';
...
echo "Your message has been sent, we will contact you as soon as possible.";
}
} else {
echo "<span>* Your message cannot be send, please try again *</span>";
}
?>