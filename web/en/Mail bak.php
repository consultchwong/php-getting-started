...
class Mail{ 
	...
	var	$send_from = "-- HK Thyroid & Hernia Centre  --"; /* The email sender name */
	var $to = 'louis@01link.net'; /* The email receiver */
	var $subject = 'New enquiry from web site'; /* Email subject */
